interface OperationalControlPageTableSkeletonProps {
    columns?: number;
    rows?: number;
  }
  
  export default function OperationalControlTableSkeleton({ columns = 8, rows = 5 }: OperationalControlPageTableSkeletonProps) {
    return (
